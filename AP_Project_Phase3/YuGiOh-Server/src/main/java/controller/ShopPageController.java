...
public class ShopPageController extends Controller {
    ...
    public void increaseNumberOfCardInStock(String cardName) {
        Card.getCardByName(cardName).increaseNumberOfAvailableCardsInShop();
    }

    public void decreaseNumberOfCardInStock(String cardName) {
        Card.getCardByName(cardName).decreaseNumberOfAvailableCardsInShop();
    }

    public void forbidBuyingCard(String cardName) {
        Card.getCardByName(cardName).setForbiddenToBuy(true);
    }

    public void startBuyingCard(String cardName) {
        Card.getCardByName(cardName).setForbiddenToBuy(false);
    }
}
