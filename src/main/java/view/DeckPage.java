...
public class DeckPage extends Page {
    ...
    public void runDeckPage(String command) {
        String[] commandPatterns = {
                ...
                "deck delete (\\S+)",
                "deck set-activate (\\S+)",
                "deck add-card --card (\\S+) --deck (\\S+)( --side)?",
                "deck add-card --card (\\S+)( --side)? --deck (\\S+)",
                "deck add-card --deck (\\S+) --card (\\S+)( --side)?",
                "deck add-card --deck (\\S+)( --side)? --card (\\S+)",
                "deck add-card( --side)? --card (\\S+) --deck (\\S+)",
                "deck add-card( --side)? --deck (\\S+) --card (\\S+)",
                "deck rm-card --card (\\S+) --deck (\\S+)( --side)?",
                "deck rm-card --card (\\S+)( --side)? --deck (\\S+)",
                "deck rm-card --deck (\\S+) --card (\\S+)( --side)?",
                "deck rm-card --deck (\\S+)( --side)? --card (\\S+)",
                "deck rm-card( --side)? --card (\\S+) --deck (\\S+)",
                "deck rm-card( --side)? --deck (\\S+) --card (\\S+)",
                "deck show --all",
