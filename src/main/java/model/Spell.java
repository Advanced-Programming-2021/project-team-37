...
public class Spell extends SpellAndTrap {
    ...
    public int getCounterMonsterCards() {
        return counterMonsterCards;
    }

    public void setCounterMonsterCards(int counterMonsterCards) {
        this.counterMonsterCards = counterMonsterCards;
    }
